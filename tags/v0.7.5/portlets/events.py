...
class Renderer(base.Renderer):
    ...
    def _data(self):
        ...
        brains = catalog(portal_type=('Event', 'ELEvent'),
                       review_state=state,
                       end={'query': DateTime(),
                            'range': 'min'},
                       path=path,
...
class AddForm(base.AddForm):
    ...
    label = _(u"Add EL Events Portlet")
    description = _(u"This portlet lists upcoming Events and EL Events.")
...
class EditForm(base.EditForm):
    form_fields = form.Fields(IEventsPortlet)
    label = _(u"Edit EL Events Portlet")
    description = _(u"This portlet lists upcoming Events and EL Events.")
